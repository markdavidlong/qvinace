...
const unsigned char color_r[16] = {0x00, 0xdd, 0x00, 0xdd,
                   ...
                   0x88, 0xff, 0xaa, 0xff,
                   0x11, 0xff, 0x44, 0xff};
const unsigned char color_g[16] = {0x00, 0x00, 0x00, 0x22,
        0x77, 0x55, 0x22, 0xaa,
        0x55, 0x66, 0xaa, 0x99,
        0xdd, 0xff, 0xff, 0xff};


const unsigned char color_b[16] = {0x00, 0x33, 0x99, 0xdd,
        0x22, 0x55, 0xff, 0xff,
        0x00, 0x00, 0xaa, 0x88,
        0x00, 0x00, 0x99, 0xff};

const unsigned char bw_value[16] = {0x00, 0x5b, 0x33, 0x9f,
        0x33, 0x55, 0x6c, 0xB0,
        0x4a, 0x77, 0xaa, 0xb5,
        0x4f, 0xaa, 0x9f, 0xff};
...
public:
    ...
    // renderToPixmap should take a bitmap from a CVideoRenderer
    //   and colorize it for ntsc, color for mono dislay, etc.
    // A Param list should probably request an output device type, etc.
