...
QImage &CVideoRenderer::renderFullToBitmap(QImage &bitmap)
{
    return renderToBitmap(bitmap,0,23);
}
...
QImage &CVideoRenderer::renderTopToBitmap(QImage &bitmap)
{
    return renderToBitmap(bitmap,0,19);
}
...
QImage &CVideoRenderer::renderBottomToBitmap(QImage &bitmap)
{
    return renderToBitmap(bitmap,20,23);
}
